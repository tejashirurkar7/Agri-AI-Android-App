...
public class sataraPieChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_satara_pie_chart);
    ...
    private void setData()
    {
        ...
        tvPython.setText(Integer.toString(45));
        tvCPP.setText(Integer.toString(40));
        tvJava.setText(Integer.toString(25));

        tvVeg1.setText(Integer.toString(20));
        tvVeg2.setText(Integer.toString(15));
        tvVeg3.setText(Integer.toString(8));
